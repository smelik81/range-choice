window.addEventListener('load', function () {
    ...
    const positionFilter = document.querySelectorAll("input[type='radio']");
   ...
   nameFilter.addEventListener("input", (event) => {
    ...
    positionFilter.forEach((filter) => {
      filter.addEventListener("change", () => {
        const filteredPosition = filter.value;
        const filteredUsersPosition = userArray.filter((user) => {
          return (
            filteredPosition === "all" || user.position === filteredPosition
          );
        });
